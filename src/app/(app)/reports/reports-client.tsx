            ...
            <CardHeader>
              <div className="flex items-center justify-between gap-3 flex-wrap">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    แสดงนักเรียนที่มีใบเสร็จจากหน้า &quot;พิมพ์ใบเสร็จรับเงินชั่วคราว&quot; แต่ยังไม่ได้รับสินค้า (ถือว่ายังจ่ายไม่ครบ)
                    ห้อง/ชั้น/รหัส = ข้อมูลล่าสุดจากระบบจับคู่รายชื่อ
                    ใบแจ้งชำระระบุ 3 รายการสำคัญ: ค่าประกันอุบัติเหตุ 400฿ · Student Care 150฿ · สมาคมผู้ปกครอง 200฿
                  </p>
                </div>
                <Button
                  variant="outline"
